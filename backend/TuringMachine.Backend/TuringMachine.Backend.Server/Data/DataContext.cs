...
using TuringMachine.Backend.Server.Data.SqlDataModel.UI.MachineLabels;
using TuringMachine.Backend.Server.Data.SqlDataModel.UserManagement;

namespace TuringMachine.Backend.Server.Data
{
    internal class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Machine>()
                        .HasKey(machine => machine.DesignID);
            modelBuilder.Entity<MachineDesign>()
            ...
            modelBuilder.Entity<TransitionStatement>()
                        .HasKey(statement => statement.TransitionID);
